...
" Proto
call <SID>AddAlternateExtensionMapping('pb.h', 'proto')
call <SID>AddAlternateExtensionMapping('pb.cc', 'proto')
call <SID>AddAlternateExtensionMapping('proto', 'pb.h,pb.cc')
" Mappings for C and C++
call <SID>AddAlternateExtensionMapping('h',"cpp,c,inl,cxx,cc,CC,jce,Jce,JCE,proto")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,CXX,CC,jce,Jce,JCE")
...
call <SID>AddAlternateExtensionMapping('CPP',"H,HPP")
call <SID>AddAlternateExtensionMapping('cc',"h,proto")
...
if (!exists('g:alternateSearchPath'))
  let g:alternateSearchPath = 'sfr:../source,sfr:../src,sfr:../include,sfr:../inc,sfr:./Generated,sfr:..'
endif
