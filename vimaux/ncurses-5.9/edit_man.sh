...
TERMINFO="/data/home/liujinqiao/vimaux/ncurses-5.9/install/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /data/home/liujinqiao/vimaux/ncurses-5.9/man_alias.sed ; then
cat >>/data/home/liujinqiao/vimaux/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /data/home/liujinqiao/vimaux/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /data/home/liujinqiao/vimaux/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /data/home/liujinqiao/vimaux/ncurses-5.9/man_alias.sed \
		< $i >$TMP
